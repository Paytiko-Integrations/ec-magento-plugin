    ...
    function ($, _, mageTemplate) {
        ...
        return {
            build: function (formData) {
                ...
                var formTmpl = mageTemplate('<style>.paytiko-cashier { width:100%; height:100%; border:none } .modal-content{height:502px}</style><div class="callfor-popup" id="placeholder_paytikonew">'+
                    '</div>');
